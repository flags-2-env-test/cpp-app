...
```bash
git clone --recurse-submodules https://github.com/flags-2-env-test/cpp-app
cd cpp-app
docker build -t f2e-fixture-cpp .
docker run --rm f2e-fixture-cpp
```
...
docker run --rm -v /tmp/mutant.toml:/app/.cli-flags.toml:ro f2e-fixture-cpp
